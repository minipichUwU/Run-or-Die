package fr.epita.mti.jee.run_or_die.infrastructure.persistence.repository.edition;
...
import fr.epita.mti.jee.run_or_die.infrastructure.persistence.entities.embeddable.EmbeddableMaxCapacity;
...
import fr.epita.mti.jee.run_or_die.infrastructure.persistence.repository.runner.RunnerRepositoryJpa;
import fr.epita.mti.jee.run_or_die.infrastructure.persistence.repository.zombie.ZombieRepositoryJPA;
...
public class EditionRepositoryImpl implements EditionRepository {
    ...
    @Override
    public Optional<Edition> find(Edition domainEditionName) {
        return editionRepositoryJPA
