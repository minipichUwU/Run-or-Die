package fr.epita.mti.jee.domain.models.zombie;

import fr.epita.mti.jee.domain.exceptions.edition.CancelledEditionException;
import fr.epita.mti.jee.domain.exceptions.participants.InvalidRegistrationDateException;
import fr.epita.mti.jee.domain.exceptions.participants.zombie.MaxZombieCapacityReachedException;
import fr.epita.mti.jee.domain.exceptions.participants.zombie.OutsideEditionTimeSlotException;
import fr.epita.mti.jee.domain.exceptions.participants.zombie.OverlappingZombieAffectationsException;
import fr.epita.mti.jee.domain.exceptions.participants.zombie.RegisteredAsRunnerException;
